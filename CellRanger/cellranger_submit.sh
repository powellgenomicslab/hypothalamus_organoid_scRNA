...
do
	...
	ref="/path/to/refdata-gex-GRCh38-2020-A_w_tdtomato" # define reference path, this reference was edited to contain the tdtomato gene since it is located on the 3' end of the TH gene
